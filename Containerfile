...
RUN zypper -n in git-core git-lfs gh glab gitea-tea bat less cnf cnf-bash openssh-clients gpg2 ca-certificates-suse command-not-found \
    python3 python3-pip python3-uv perl perl-Perl-Tidy ShellCheck npm jq python313-ruff python313-flake8 python313-yamllint yq iputils \
    forgejo-cli kubernetes-client kustomize gitea-tea osc obs-service-* osc-plugin-qam
